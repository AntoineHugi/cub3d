...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/16 11:23:24 by ahugi             #+#    #+#             */
/*   Updated: 2025/07/18 08:40:53 by bokwuful         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_wall_distance(t_raycasting *ray, t_map *map, int i)
{
	if (ray->side_hit == 0)
